...
public class InterfaceTest {
	...
	public void testLoginFail() {
		...
		String url = "http://localhost:8080/Blog/login.do";
		String data = "userName=tiancong&password=1234561";
		try {
            String json = queryData(url, data);
			Gson gson = new Gson();
			BaseModel baseModel = gson.fromJson(json, BaseModel.class);
	...
	public void testInsertFail(){
		...
		String url = "http://localhost:8080/Blog/insertArticle.do";
		String data = "userName=tiancong&title=Java IO&tag=java";
		try {
            String json = queryData(url, data);
			Gson gson = new Gson();
			BaseModel baseModel = gson.fromJson(json, BaseModel.class);
	...
	public void testUpdateFail(){
		...
		String url = "http://localhost:8080/Blog/updateArticle.do";
		String data = "&articleId=2&title=Java IO&tag=java&content=java io study";
		try {
            String json = queryData(url, data);
			Gson gson = new Gson();
			BaseModel baseModel = gson.fromJson(json, BaseModel.class);
...
//		String data = "userName=tiancong&articleId=4";
//		try {
//            String json = queryData(url, data);
//			Gson gson = new Gson();
//			BaseModel baseModel = gson.fromJson(json, BaseModel.class);
